...
FUNCTION CTOF(
    ...
    RETURN NUMBER;
END HEATINDEXPACKAGE;

CREATE OR REPLACE PACKAGE BODY HEATINDEXPACKAGE AS 
    CREATE OR REPLACE FUNCTION HEATINDEX(
        TMP NUMBER,
        RH NUMBER
    )
    RETURN NUMBER
    ...
    BEGIN
        ...
        RETURN RETTMP;
    END;
    CREATE PROCEDURE ROLLUPHOURSHI (
        STATION NUMBER,
        TARGET_DAY VARCHAR2(8)
    )
    IS 
    BEGIN
